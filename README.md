...
**Note: Photo measurements can only be performed on cameras that support an electronic shutter mode, ie not EFCS and not the mechanical shutter mode.**
 ...
 8. Click the <a href="https://photos.smugmug.com/photos/i-XmSR7ck/0/DVHKh3bTGQZ4qnBK2ZJK8KHNBMwd7HGZzf8RnPkH9/O/i-XmSR7ck.png" target="_blank">rightward-facing arrow at the top of the window</a> to compile and flash the LED toggling module to your board. It should complete within 30 seconds. To verify the logic is running, go to Tools -> Serial Monitor and set the baud rate to 115,200. You should see a " Starting...500 Hz (1000 toggles/sec)" message, preceded by a timestamp. If not, cycle power on the board to restart it.
